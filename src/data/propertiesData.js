export const propertiesData = [
  ...
  {
    id: 10,
    title: 'Ultra-Luxury 5BHK Villa in Beverly Estates',
    propertyType: 'Villas',
    purpose: 'selling',
    propertyLength: '6500 sqft',
    areaValue: 6500,
    location: { city: 'Mumbai', locality: 'Worli', projectName: 'Beverly Estates' },
    city: 'Mumbai',
    pricing: { expectedPrice: 220000000 },
    price: '₹22 Cr',
  ...
  {
    id: 11,
    title: 'Modern IT Park Office Complex',
    propertyType: 'Commercial',
    purpose: 'renting',
    propertyLength: '12000 sqft',
    areaValue: 12000,
    location: { city: 'Bangalore', locality: 'Electronic City' },
    city: 'Bangalore',
    pricing: { expectedPrice: 850000 },
    price: '₹8.5 L/mo',
    img: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&q=80',
  ...
  },
  {
    ...
    propertyLength: '4500 sqft',
    areaValue: 4500,
    location: { city: 'Hyderabad', locality: 'Mokila' },
    city: 'Hyderabad',
    pricing: { expectedPrice: 16500000 },
    price: '₹1.65 Cr',
    img: 'https://images.unsplash.com/photo-1524813686514-a57563d77965?w=600&q=80',
    loc: 'Mokila, Hyderabad',
    beds: '0',
    baths: '0',
    size: '4,500 sqft',
    badge: 'Corner Plot',
  ...
  },
  {
    ...
    propertyLength: '2400 sqft',
    areaValue: 2400,
    location: { city: 'Chennai', locality: 'Adyar' },
    city: 'Chennai',
    pricing: { expectedPrice: 45000000 },
    price: '₹4.5 Cr',
    img: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=600&q=80',
    loc: 'Adyar, Chennai',
    beds: '3',
  ...
  {
    id: 14,
    title: 'Boutique Resort Property',
    propertyType: 'Lands',
    purpose: 'selling',
    propertyLength: '3 Acres',
    areaValue: 130680,
    location: { city: 'Lonavala', locality: 'Aamby Valley' },
    city: 'Pune',
  ...
  },
  {
    ...
    propertyType: 'Flats',
    purpose: 'selling',
    propertyLength: '950 sqft',
    areaValue: 950,
    location: { city: 'Hyderabad', locality: 'Kukatpally' },
    city: 'Hyderabad',
    pricing: { expectedPrice: 8500000 },
    price: '₹85 L',
    img: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=600&q=80',
