...
export const BuyIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: '14px', height: '14px', flexShrink: 0 }}><path d="M3 9l1-5h16l1 5" />  <path d="M3 9h18v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9z" /><path d="M9 9v3a3 3 0 0 0 6 0V9" /></svg>;
