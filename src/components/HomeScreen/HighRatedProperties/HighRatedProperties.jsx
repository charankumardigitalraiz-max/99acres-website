    ...
    <section className="py-6 bg-[#f8fafc]">
      <div className="container mx-auto px-4 lg:px-[22px] max-w-[1350px]">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-[14px] gap-3.5 md:gap-0">
          <div>
            <div className="inline-block text-amber-500 text-[0.72rem] font-medium uppercase tracking-[0.1em] mb-1.5">Top Rated</div>
            <div className="text-[1.35rem] sm:text-2xl md:text-[1.35rem] font-medium text-[#0f172a] tracking-[-0.01em] mb-0.5">Highest Rated Properties</div>
            <div className="text-[0.88rem] text-slate-600 mt-0.5 max-w-[600px] font-normal">Properties loved by customers and highly reviewed</div>
          </div>
          <div className="flex items-center justify-between md:justify-end gap-3 w-full md:w-auto mt-1 md:mt-0">
            <div className="flex items-center gap-3">
              <button className="slide-prev-btn w-10 h-10 rounded-full border border-slate-200 bg-white flex items-center justify-center text-[#0f172a] transition-all duration-300 hover:bg-[#0f172a] hover:text-white hover:border-[#0f172a] hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.15)] disabled:opacity-30 disabled:pointer-events-none group shadow-[0_2px_8px_rgba(0,0,0,0.05)]">
                <ChevronL />
              </button>
              <button className="slide-next-btn w-10 h-10 rounded-full border border-slate-200 bg-white flex items-center justify-center text-[#0f172a] transition-all duration-300 hover:bg-[#0f172a] hover:text-white hover:border-[#0f172a] hover:-translate-y-0.5 hover:shadow-[0_8px_20_rgba(0,0,0,0.15)] disabled:opacity-30 disabled:pointer-events-none group shadow-[0_2px_8px_rgba(0,0,0,0.05)]">
                <ChevronR />
              </button>
              <div className="w-[1px] h-6 bg-slate-200 mx-2 hidden md:block"></div>
            </div>
            <Link to="/high-rated-properties" className="flex items-center gap-2 text-amber-500 text-[0.85rem] font-medium transition-all duration-200 hover:gap-3 hover:opacity-80">
              View All <ArrowR />
            </Link>
          </div>
        </div>
